...
describe('sagaFinishBase', () => {
  ...
  it('calls finishTroopBaseMovement with correct args', async () => {
    ...
    assert.deepStrictEqual((finishTroopBaseMovement as MockInstance).mock.calls[0][0], { player_id, movement_id })
  })
  ...
  it('calls rebaseTroopMovement when LIMIT_REACHED error is thrown', async () => {
    ...
    assert.deepStrictEqual((rebaseTroopMovement as MockInstance).mock.calls[0][0], { player_id, movement_id })
  })
